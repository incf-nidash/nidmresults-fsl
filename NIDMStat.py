...
class NIDMStat():
    ...
    def create_model_fitting(self, residuals_original_file, grand_mean_original_file, mask_file, design_matrix):
        ...
        self.provBundle.entity(NIIRI['mask_id_1'], 
            other_attributes=( (PROV['type'],NIDM['MaskMap'],), 
                               ...
                               (NIDM['inCoordinateSpace'], self.create_coordinate_space(mask_file))))
        self.provBundle.wasGeneratedBy(NIIRI['mask_id_1'], NIIRI['model_parameters_estimation_id'])  
    ...
    def create_contrast_map(self, cope_original_file, var_cope_original_file, stat_original_file, 
        ...
        self.provBundle.used(NIIRI['contrast_estimation_id_'+contrast_num], NIIRI['mask_id_1'])  
        ...
        self.provBundle.entity(NIIRI['statistic_map_id_'+contrast_num ],
            other_attributes=(  (PROV['type'], NIDM['StatisticMap']), 
                                ...
                                (NIDM['inCoordinateSpace'], self.create_coordinate_space(stat_file)),
                                ) )
        ...
        self.provBundle.used(NIIRI['inference_id_'+contrast_num], NIIRI['mask_id_1'])  
    ...
    def create_coordinate_space(self, niftiFile):
        ...
        self.provBundle.entity(NIIRI['coordinate_space_id_1'], other_attributes=mydict)
